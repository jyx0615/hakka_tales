            ...
            <div className="row w-100">
                ...
                <div className="col col-2 pt-5 d-lg-block d-none">
                    <div className="position-fixed border-start border-3">
                        ...
                        {/* Dropdown Menu */}
                        <ul className="dropdown-menu bg-transparent border-0" aria-labelledby={`dropdownCheckbox-${typeIndex}`}>
                            {books[type].map((bookName, index) => (
                            <li key={index} className="list-group-item bg-transparent border-0">
                                <Link to={`/book/${index}`} className="text-decoration-none custom-a dropdown-item">
                                {bookName}
                                </Link>
