...
function MyButton({ text, bookIndex, type }) {
  ...
  return (
    ...
    <div className={`custom-btn d-flex align-items-center justify-content-center  ${type}`}>
      <button href="#" className='position-relative d-inline-flex align-items-center justify-content-center px-1 py-2 border-0 bg-transparent rounded-2 custom-button w-100 h-100' onClick={handleClick}>
